...
const Home = () => {
  return (
    ...
    <div className="text-overlay">
        ...
        <p>Innovative school that offers a high-quality education while remaining one of the most affordable universities in the country.</p>
      </div>
...
<h5>
We are committed to providing a safe and welcoming environment for all international students. Our International Student Services (ISS) team is here to help you with everything from applying for a visa to finding housing and getting involved on campus.
<br/><br/>
 We also offer a variety of programs and services to help you succeed in your education and beyond.
</h5>
</div>
...
<h5>Here, your education extends beyond books to include service-learning projects, study abroad opportunities and real-world experiences. Plus, Here is the state leader in degree completion among public universities. Statistics recently released by the Department of Higher Education (MDHE) show that our degree completion rate per full-time equivalent (FTE) is the highest among all of public universities and more than double the state benchmark.

<br/><br/> 

Here we strive to give you the student services, resources and support you need to experience academic success and earn your degree on time. Take classes online or on our campuses. Take the Virtual Self-Guided Tour to view to our campuses before visiting in person.</h5>   
